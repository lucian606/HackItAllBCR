...
class CompanyModel extends Model {
  ...
  const CompanyModel._internal({required this.id, name, value}): _name = name, _value = value;
  
  factory CompanyModel({String? id, String? name, double? value}) {
  ...
  CompanyModel copyWith({String? id, String? name, double? value}) {
    return CompanyModel(
      id: id ?? this.id,
      name: name ?? this.name,
